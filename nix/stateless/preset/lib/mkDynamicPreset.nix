...
in
  lib.mkIf enabled {
    environment.persistence."${persistentStorageMountpoint}".directories = persistentDirectoriesAccessor inputs;
    environment.persistence."${persistentStorageMountpoint}".files = persistentFilesAccessor inputs;
  }
